...
const Contact = () => {
    ...
    formData.append("access_key", "f753ac91-05c1-4f4d-81ca-52a1a3b824b3");
    ...
    return (
        ...
        transition={{duration: 0.5,delay: 0.7}}
            className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>I’m always open to connecting with professionals and companies.</motion.p>
        ...
        transition={{duration: 0.5,delay: 0.9}}
            onSubmit={onSubmit}className='max-w-2xl mx-auto'>
                ...
                text-white rounded-full mx-auto hover:bg-black duration-500'>Submit Now <Image src={assets.right_arrow_white} alt='' className='w-4'/></motion.button>
